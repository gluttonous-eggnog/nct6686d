// add for reference - git://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git@be7d9294a411aa116d9f5874bd0ad982bb3eb7cc
...
// Modified for newer kernels that expect this to return nothing
